...
public class ModBlockModelGenerators extends BlockModelGenerators {
    final List<Block> nonOrientableTrapdoor = ImmutableList.of(Blocks.OAK_TRAPDOOR, Blocks.DARK_OAK_TRAPDOOR, Blocks.IRON_TRAPDOOR, ModBlocks.YIRA_TRAPDOOR.get());
    ...
    public void run() {
        ...
        createRotatedPillarWithHorizontalVariant(ModBlocks.YIRA_LOG.get());
        createRotatedPillarWithHorizontalVariant(ModBlocks.STRIPPED_YIRA_LOG.get());
        createWOOD(ModBlocks.YIRA_WOOD.get());
        createWOOD(ModBlocks.STRIPPED_YIRA_WOOD.get());
        createLeave(ModBlocks.YIRA_LEAVES.get());
        createSapling(ModBlocks.YIRA_SAPLING.get());
//        createTrivialCube(ModBlocks.BEAN_BLOCK.get());
    ...
    protected void createRotatedPillarWithHorizontalVariant(Block pPillar) {
        TextureMapping textureMapping = TextureMapping.logColumn(pPillar);
        ResourceLocation resourcelocation = ModModelTemplates.PILLAR.create(pPillar, textureMapping, this.modelOutput);
        ResourceLocation resourcelocation1 = ModModelTemplates.PILLAR_HORIZONTEL.create(pPillar, textureMapping, this.modelOutput);
        this.blockStateOutput.accept(createRotatedPillarWithHorizontalVariant(pPillar, resourcelocation, resourcelocation1));
        this.registerSimpleItemModel(pPillar, resourcelocation1);
    }

    protected void createWOOD(Block pPillar) {
        TextureMapping textureMapping = TextureMapping.logColumn(pPillar);
        ResourceLocation resourcelocation = ModModelTemplates.WOOD.create(pPillar, textureMapping, this.modelOutput);
        //ResourceLocation resourcelocation1 = ModModelTemplates.PILLAR_HORIZONTEL.create(pPillar, textureMapping, this.modelOutput);
        this.blockStateOutput.accept(createSimpleBlock(pPillar, resourcelocation));
        this.registerSimpleItemModel(pPillar, resourcelocation);
    }
